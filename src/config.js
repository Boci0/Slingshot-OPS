...
export const CONFIG = {
  ...
  enemyArchetypes: {
    standard: {
      ...
      ability: null, abilityDesc: 'No special ability',
    },
    tank: {
      name: 'WALL UNIT',
      hpMult: 1.7, atkMult: 0.9, defBonus: 4, aiShift: -0.05,
      ability: 'thorns',
      abilityDesc: 'Reflects 30% of damage taken',
    },
    striker: {
      name: 'STRIKER UNIT',
      hpMult: 1.15, atkMult: 1.3, defBonus: 0, aiShift: 0.15,
      ability: 'aggressive',
      abilityDesc: 'Fires faster and more accurately',
    },
  },
  ...
  archetypeWeights: {
    1: { standard: 1, tank: 0, striker: 0 },
    2: { standard: 0.7, tank: 0.2, striker: 0.1 },
    3: { standard: 0.5, tank: 0.3, striker: 0.2 },
    4: { standard: 0.3, tank: 0.4, striker: 0.3 },
    5: { standard: 0.2, tank: 0.4, striker: 0.4 },
    elite: { standard: 0.1, tank: 0.4, striker: 0.5 },
    miniboss: { standard: 0.1, tank: 0.4, striker: 0.5 },
    boss: { standard: 0, tank: 0.5, striker: 0.5 },
  },
